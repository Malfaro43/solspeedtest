...
random_words = pd.read_csv('unigram_freq.csv')
normal_quotes = pd.read_csv('quotes.csv')
asol = pygame.image.load('asol.png')
pygame.display.set_icon(pygame.transform.scale(asol, (88, 88)))
asol = pygame.transform.scale(asol, (80, 80))
bg_img = pygame.image.load('asolbg.png')
bg_img = pygame.transform.scale(bg_img, (600, 500))
with open('asol_quotes.json') as f:
   asol_quotes = json.load(f)
sound = pygame.mixer.Sound('asolvoice.ogg')
